...
public class Smithing {
	...
	private final static int[] BAR_REQS = {1,15,20,30,40,50,70,85};
	...
	public static int getExp(int barType) {
	...
	public static int getOre(int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
	...
	public static int getOre2(int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
	...
	public static boolean canSmelt(Client c, int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
	...
	public static boolean hasOres(Client c, int barType) {
	...
	public static void readInput(int level, String type, Client c, int amounttomake) {
