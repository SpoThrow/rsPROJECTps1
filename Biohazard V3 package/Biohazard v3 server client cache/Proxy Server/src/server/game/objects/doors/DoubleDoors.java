...
public class DoubleDoors {
	...
	public List<DoubleDoors> doors = new ArrayList<DoubleDoors>();
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			new Object(-1, d.x, d.y, d.z, 0, 0, -1, -1, 0);
		...
		new Object(d.doorId, d.x, d.y, d.z, getNextLeftFace(d), 0, -1, -1, 0);
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		new Object(d.doorId, d.x, d.y, d.z, getNextRightFace(d), 0, -1, -1, 0);
	...
	public void load() {
		...
		System.out.println("[Stage 7] "+ doors.size() +" double doors have been loaded in "+ (System.currentTimeMillis() - start) +"ms...");
	}
