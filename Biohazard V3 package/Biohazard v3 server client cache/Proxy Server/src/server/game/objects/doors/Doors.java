...
public class Doors {
	...
	public List<Doors> doors = new ArrayList<Doors>();
	...
	public boolean handleDoor(int id, int x, int y, int z) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			...
			new Object(-1, d.doorX, d.doorY, d.doorZ, 0, d.type, -1, -1, 0);
		...
		new Object(d.doorId, d.doorX, d.doorY, d.doorZ, getNextFace(d), d.type, d.doorId, -1, 0);
