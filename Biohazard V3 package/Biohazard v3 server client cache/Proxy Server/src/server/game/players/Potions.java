...
public class Potions {
	...
	public void handlePotion(int itemId, int slot) {
		...
		if (System.currentTimeMillis() - c.potDelay >= 1200) {
            ...
            if(item.endsWith("glory(4)")
            		|| item.endsWith("glory(3)") || item.endsWith("glory(2)")
            		|| item.endsWith("dueling(4)") || item.endsWith("glory(1)")
            		|| item.endsWith("dueling(3)") || item.endsWith("dueling(2)")
            		|| item.endsWith("dueling(1)"))
            	return;
            if(item.endsWith("(4)"))
			{
			...
			//Magic pots
				...
				break;
				case 5759:
				drinkSlayerPotion(itemId,1919,slot,0,true); //slayer's respite
				break;
				case 145:
				...
				case 3008:
					if (c.playerEnergy < 99) {
									c.playerEnergy += 20;
									c.getItems().addItem(3010,1);
									c.getItems().deleteItem(3008,1);
									c.sendMessage("You drink a dose of your energy potion, you have 3 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
									break;
								case 3010:
					if (c.playerEnergy < 99) {
									c.playerEnergy += 20;
									c.getItems().addItem(3012,1);
									c.getItems().deleteItem(3010,1);
									c.sendMessage("You drink a dose of your energy potion, you have 2 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 20;
									c.getItems().addItem(3014,1);
									c.getItems().deleteItem(3012,1);
									c.sendMessage("You drink a dose of your energy potion, you have 1 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 20;
									c.getItems().deleteItem(3014,1);
									c.sendMessage("You finished you energy potion.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 40;
									c.getItems().addItem(3018,1);
									c.getItems().deleteItem(3016,1);
									c.sendMessage("You drink a dose of your super energy potion, you have 3 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 40;
									c.getItems().addItem(3020,1);
									c.getItems().deleteItem(3018,1);
									c.sendMessage("You drink a dose of your super energy potion, you have 2 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 40;
									c.getItems().addItem(3022,1);
									c.getItems().deleteItem(3020,1);
									c.sendMessage("You drink a dose of your super energy potion, you have 1 doses left.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
					...
					if (c.playerEnergy < 99) {
									c.playerEnergy += 40;
									c.getItems().deleteItem(3022,1);
									c.sendMessage("You finished you super energy potion.");
									c.startAnimation(0x33D);
					} else if (c.playerEnergy > 99) {
					c.sendMessage("Your energy is already 100%.");
					}
	...
	public void drinkSlayerPotion(int itemId, int replaceItem, int slot, int stat, boolean sup) {
		c.startAnimation(829);
		c.playerItems[slot] = replaceItem + 1;
		c.getItems().resetItems(3214);
	...
	public void antifirePot(int itemId, int replaceItem, int slot){
		...
		c.antiFirePot = true;
		c.antiFirePotion();
		c.sendMessage("Your immunity against dragon fire has been increased.");
		c.getItems().resetItems(3214);
	}
	...
	public boolean isPotion(int itemId) {
		...
		return name.contains("respite") || name.contains("(4)") || name.contains("(3)") || name.contains("(2)") || name.contains("(1)");	
	}
}